import Logo from "../component/assets/images/swiggy.png";
...
const Title = () =>{
  ...
  const Header = () =>{
    ...
    const toggle = () => {
      // React automatically provides the current state (isToggled) as prevValue
      setLoginClicked((loginClicked) => 
      !loginClicked,
      // setLoginClicked((loginClicked === true) ? <SignupForm/> : false
      );
    };
    ...
    return(
      <div className="header">
        ...
        <ul>
          ...
          <li>Cart</li>
          <li> <button className="btnLogin" onClick={toggle}> LOGIN </button></li>
          {loginClicked ? <SignupForm toggle={toggle}/> : null}
        </ul>
